...
public class ControladorEnvio implements IEnvio {
    ...
    public Valoracion buscarValoracionId(int idEnvio) {
        return this.servicioEnvio.buscarValoracionPorId(idEnvio);
    }
    ...
    public ArrayList<Valoracion> obtenerValoraciones() {
        return this.servicioEnvio.obtenerValoraciones();
    }
    
    public void crearValoracion(int idEnvio, int puntaje, String comentario) {
        this.servicioEnvio.crearUnaValoracion(idEnvio, puntaje, comentario);
    }
